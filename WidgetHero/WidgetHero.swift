...
struct Provider: IntentTimelineProvider {
    ...
    func placeholder(in context: Context) -> SimpleEntry {
        SimpleEntry(date: Date(), configuration: ConfigurationIntent(), hero: Superhero(image: "spiderman", name: "Spiderman", realName: "Peter Parker"))
    }
...
struct WidgetHero: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .description("Your choosen Widget Hero")
    }
}
